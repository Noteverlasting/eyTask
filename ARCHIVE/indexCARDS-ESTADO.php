...
<head>
    ...
    <link rel="stylesheet" href="css/gestorCARDS-ESTADO.css">
</head>
<body>
    <header>
...
// Cards apiladas: solo una card (estado) en primer plano
document.querySelectorAll('.estadosTareas > div').forEach(function(card) {
    card.addEventListener('click', function() {
        document.querySelectorAll('.estadosTareas > div').forEach(function(c) {
...
window.addEventListener('DOMContentLoaded', function() {
    var firstCard = document.querySelector('.estadosTareas > div');
