...
var idioma = cookies.language || navigator.language.slice(0,2) || "es"; // Obtener el idioma del navegador
...
function cambiarIdioma(idioma, jsonIdiomas) {
  ...
  document.querySelector("#namelabel").textContent = jsonIdiomas[idioma]["namelabel"];
}